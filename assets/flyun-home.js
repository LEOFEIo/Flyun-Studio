(() => {
  ...
  const copy = {
    zh: {
      ...
      'nav.contact': '开始合作',
      'nav.menu': '打开菜单',
      announce: 'YUNFEI XU · INTERACTION DESIGN PORTFOLIO 2026',
      'hero.kicker': '许云飞 · 交互设计师 / 产品构建者 / 实时 3D 创作者',
      'hero.title': '我设计可以进入的系统，<br><em>也把它们真正做出来。</em>',
      'hero.copy': '从视觉传达、Unity 与虚拟空间，到 AIGC、产品设计和人才智能，我用设计与代码把复杂问题转化为可运行、可参与的体验。',
      'hero.primary': '查看代表作品',
      'hero.secondary': '与我联系',
      'hero.online': 'MODEL ONLINE',
      'hero.card1': '虚拟校史馆与文化体验',
      'hero.card2': 'AI 产品与人才系统',
      'hero.card3': '实时 3D 与互动游戏',
      'hero.visual': '拖拽旋转 · 点击部件 · 切换姿态 · 拆解模型',
      ...
      'scenes.title': '不是概念拼贴，<br><em>是已经能跑的作品。</em>',
      'scenes.copy': '从虚拟文化空间、AI 产品到实时交互，每个作品都包含策略、视觉、原型和可运行界面。',
      'scenes.one': '江汉大学虚拟校史馆',
      'scenes.one.copy': '把校史资料重构成可漫游、可探索、可共同发现的数字文化空间。',
      'scenes.two': '超级猎头 AI 操作系统',
      'scenes.two.copy': '把研究、人才洞察与多模态 Agent 组织成一套面向真实工作的产品界面。',
      'scenes.three': '飞云寻访空间',
      'scenes.three.copy': '让能力、角色与组织语境进入同一个可视化空间，支持更深的人才判断。',
      'scenes.four': '信号场互动实验',
      'scenes.four.copy': '一个将光标、键盘与触摸输入转译为连接任务的实时网页游戏。',
    ...
    en: {
      ...
      'nav.menu': 'Open menu',
      announce: 'YUNFEI XU · INTERACTION DESIGN PORTFOLIO 2026',
      'hero.kicker': 'Yunfei Xu · Interaction designer / Product builder / Real-time 3D creator',
      'hero.title': 'I design systems you can enter—<br><em>then make them real.</em>',
      'hero.copy': 'Across visual communication, Unity, virtual space, AIGC, product design and talent intelligence, I turn complex problems into experiences people can run, enter and shape.',
      'hero.primary': 'View selected work',
      'hero.secondary': 'Contact me',
      'hero.online': 'MODEL ONLINE',
      'hero.card1': 'Virtual archives & culture',
      'hero.card2': 'AI product & talent systems',
      'hero.card3': 'Real-time 3D & interactive games',
      'hero.visual': 'Drag to rotate · Click a part · Change pose · Explode model',
      ...
      'scenes.title': 'Not a concept collage—<br><em>work you can actually run.</em>',
      'scenes.copy': 'Across virtual culture, AI products and live interaction, every project connects strategy, visual design, prototyping and a working interface.',
      'scenes.one': 'Jianghan University Virtual Archive',
      'scenes.one.copy': 'Reframe university history as a digital cultural space people can wander, explore and discover together.',
      'scenes.two': 'AI Operating System for Executive Search',
      'scenes.two.copy': 'Organize research, talent intelligence and multimodal agents into an interface made for real work.',
      'scenes.three': 'Flyun Spatial Talent Space',
      'scenes.three.copy': 'Bring capability, role and organizational context into one visual space for deeper talent judgment.',
      'scenes.four': 'Signal Field Interactive Experiment',
      'scenes.four.copy': 'A real-time web game that turns pointer, keyboard and touch input into a connection mission.',
