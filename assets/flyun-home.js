(() => {
  ...
  const copy = {
    zh: {
      ...
      'hero.card1': '虚拟空间与文化体验',
      'hero.card2': 'AI 产品与人才连接',
      'hero.card3': '交互原型与实时 3D',
      'hero.visual': '拖拽旋转 · 点击部件 · 切换姿态',
    ...
    en: {
      ...
      'hero.online': 'MODEL ONLINE',
      'hero.card1': 'Virtual space & culture',
      'hero.card2': 'AI products & talent',
      'hero.card3': 'Interactive prototypes & real-time 3D',
      'hero.visual': 'Drag to rotate · Click a part · Change pose',
