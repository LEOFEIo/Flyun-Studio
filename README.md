...
全站以根目录 [`DESIGN.md`](DESIGN.md) 为唯一视觉规范，采用适配飞云品牌的
Cohere-inspired 企业 AI 体系：白色编辑画布、深绿产品面板、矿物灰功能表面，
以及克制的珊瑚色信号提示。Next.js 入口由 `app/cohere-theme.css` 统一收口，
GitHub Pages 静态演示由 `cohere-static.css` 使用同一套语义色与组件规则。

- `#003c33` 仅承担品牌面板、选中态与关键产品视觉
- `#17171c` / 白色根据明暗主题承担主操作
- 珊瑚色只用于实时信号与小范围强调
